...
import com.trex.simplesample.ui.base.theme.orange
...
@Composable
fun CountryScreen(uiState: UiState<List<CountryDto>>, onNewsClick: (countryId: String) -> Unit) {
    when (uiState) {
        is UiState.Success -> {
...
@Composable
fun CountryList(countrys: List<CountryDto>, onNewsClick: (countryId: String) -> Unit) {
    LazyColumn {
...
@Composable
fun Country(country: CountryDto, onNewsClick: (countryId: String) -> Unit) {
    Button(
